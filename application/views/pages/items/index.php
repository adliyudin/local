                        ...
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <form action="<?= base_url('cartin/add') ?>" method="POST">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="qty_masuk" min="1" value="" placeholder = "example 1" class="form-control">
                            ...
                            <div class="col-md-6 mt-2">
                                <form action="<?= base_url('cartout/add') ?>" method="POST">
                                    <input type="hidden" name="id_barang" value="<?= $row->id_barang ?>">
                                    <div class="input-group">
                                        <input type="number" name="qty_keluar" min="0" max="<?= $row->qty ?>" value="" placeholder = "example 1" class="form-control">
                                        <div class="input-group-append">
