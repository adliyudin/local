...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="70x40" href="<?= base_url('assets/images/Gvin_$hop.png') ?>">
    <title><?= $title ?></title>
    <!-- Custom CSS -->
...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(<?= base_url('assets/images/big/background.jpg') ?>) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(<?= base_url('assets/images/auth/resize.jpg') ?>);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <h2 class="mt-3 text-center">LOGIN</h2>
                        <p class="text-center">Masukan alamat email dan password untuk mengakses inventory GvinShop</p>
