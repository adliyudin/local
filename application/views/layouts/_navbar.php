        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="<?= base_url('home') ?>">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img src="<?= base_url('assets/images/Gvin_$hop.png') ?>" height="120" width="200" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="<?= base_url('assets/images/Gvin $hop.png') ?>" height="120" width="200" alt="homepage" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <!-- <span class="logo-text ml-2">
                        <!-- dark Logo text -->
                       <!-- <img src="<?= base_url('assets/images/logo-text.png') ?>" height="22" width="70" alt="homepage" class="dark-logo" /> -->
                        <!-- Light Logo text -->
