    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <!-- Submemu Extra -->
                <li class="nav-small-cap"><span class="hide-menu">Tentang Kami</span></li>
                <li class="sidebar-item"> 
                    <a class="sidebar-link sidebar-link" href="https://api.whatsapp.com/send?phone=%20(Admin%20Inventory%20GvinShop)" aria-expanded="false">
